...
Der CLI-Befehl \texttt{makepackage} nimmt die Inventardatei und Presetdatei und generiert ein Ordner in dem alle Audiodateien die in der Inventardatei aufgelisteten sind sich befinden.
